...
int main(void) {
    ...
    /*
     * Parte C — Estrutura da ABB apos insercoes em sequencia:
     ...
     *
     * Verificacao manual:
     *   - No 50 (raiz): altura = 3, profundidade = 0, grau = 2  ✓
     *   - No 30: altura = 2, profundidade = 1, grau = 2          ✓
     *   - No 10 (folha): altura = 0, profundidade = 3, grau = 0  ✓
     */
